        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {userName ? ` ${userName}'s account` : " this user account"} and
...
export default function UsersTableClient({
  ...
  // Refresh function using router.refresh() instead of re-fetching
  const handleRefresh = React.useCallback(() => {
    router.refresh(); // This triggers server component re-render
  }, [router]);
